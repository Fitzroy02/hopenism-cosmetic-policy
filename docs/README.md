...
This repository maintains governance and operating principles for the Hopenism cosmetic policy framework.
...
- [Prohibited Ingredients](../safeguards/prohibited_ingredients.md)
- [Automated Checks Logic](../safeguards/automated_checks.md)
...
## Product & Platform Specs

- [Seller Dashboard UX](./seller_dashboard_ux.md)
- [Listing Flow UX](./listing_flow_ux.md)
...
1. Start with the Constitution for non-negotiable principles.
2. Use Governance for decision flow and ownership.
3. Apply Safeguards before publishing, launching, or changing policy.
4. Follow Onboarding for new contributors.
5. Revisit Culture to keep behavior aligned with values.
